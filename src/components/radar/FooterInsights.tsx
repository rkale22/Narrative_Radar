  ...
  return (
    <section className="grid gap-4 lg:grid-cols-2">
      <div className="panel relative overflow-hidden rounded-2xl px-5 py-5">
        ...
        <p className="mt-2 text-[17px] leading-snug text-white">{report.collision.summary}</p>
        <p className="mt-2 text-[13px] leading-relaxed text-[#8b93a0]">{report.collision.faultLine}</p>
      </div>
